...
bool getPartialTest2(){
    ...
    worldCup.add_player(1,1,permut1,0,0,0,true);  //a
    worldCup.add_player(2,2,permut2,0,0,0,true);  //b
    worldCup.add_player(22,2,permut3,0,0,0,true);  //c
    worldCup.add_player(3,3,permut4,0,0,0,true); //d
    worldCup.add_player(33,3,permut3,0,0,0,true); //d
    worldCup.add_player(333,3,permut5,0,0,0,true); //d
    worldCup.add_player(3333,3,permut4,0,0,0,true); //d
...
int main() {
    ...
    if (!run_test(getPartialTest1, "getPartialTest1"))
        return 1;
    if (!run_test(getPartialTest2, "getPartialTest1"))
        return 1;
